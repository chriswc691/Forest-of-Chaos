...
namespace Invector.vItemManager
{
    ...
    public class vItemManagerEditor : vEditorBase
    {
        ...
        string[] ignoreProperties = new string[] { "equipPoints", "applyAttributeEvents", "items", "startItems", "onStartItemUsage", "onUseItem", "onUseItemFail", "onAddItem", "onChangeItemAmount", "onLeaveItem", "onDropItem", "onOpenCloseInventory", "onEquipItem", "onUnequipItem" };
        bool[] inEdition;
