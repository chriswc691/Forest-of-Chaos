...
{
    [vClassHeader("Trigger Change Camera State", helpBoxText = "Leave CameraState empty to return the original state system of the Player", useHelpBox = true, openClose = false)]
